...
import com.atakmap.android.mumbleptt.mumblePttDropDownReceiver;
...
public class mumblePttTool extends Tool implements ToolDescriptor {

    private final Context context;

    public mumblePttTool(Context context) {
